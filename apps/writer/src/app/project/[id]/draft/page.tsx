      ...
      <AppShell.Main style={{ position: "relative", height: "100vh", overflow: "hidden" }}>
        ...
        <div style={{ position: "relative", zIndex: 11, height: "100%" }}>
          <Flex
            ...
            gap="md"
          >
           {/* Panel Kiri - Daftar Artikel yang Diperbaiki */}
            <Box
              style={{
                width: 280, // Diperbesar dari 240px
                flexShrink: 0,
                flexGrow: 0,
                flexBasis: 280,
            ...
            >
              ...
              {/* Footer info dengan statistik */}
              {headings.length > 0 && (
                <Box mt="md" pt="md" style={{ borderTop: `1px solid ${computedColorScheme === 'dark' ? '#404040' : '#e9ecef'}` }}>
